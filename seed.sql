INSERT INTO users (name,img_url,description,auth_method,auth_id) VALUES ("Jon","","Jon's closet","","");
-- 1
INSERT INTO users (name,img_url,description,auth_method,auth_id) VALUES ("Han","","Han's closet","","");
-- 2
INSERT INTO users (name,img_url,description,auth_method,auth_id) VALUES ("Allison","","Allison's closet","","");
-- 3 
...
INSERT INTO robability (userId,voter_id,score) VALUES (1,2,3);
INSERT INTO robability (userId,voter_id,score) VALUES (2,1,5);
INSERT INTO robability (userId,voter_id,score) VALUES (3,1,2);